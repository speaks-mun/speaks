  ...
  return (
    <div className="bg-[#111] text-white min-h-screen">
      ...
      <header className="flex items-center bg-black p-4">
        <Image
          src="/5cb0f232-a897-4d8d-912b-86d8ebd85eb0.png" // place this image inside public/
          alt="Speaks Logo"
          width={120}
          height={40}
        />
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/67464751776d11d42592faffcebaf2cd.jpg')", // also inside public/
        }}
      ></div>
      ...
      <div className="p-6">
        ...
        <div className="bg-[#1a1a1a] p-4 rounded-lg leading-relaxed">
          Harvard National Model United Nations (HNMUN) is the largest, oldest,
          and most prestigious conference of its kind. Staffed entirely by
          Harvard College undergraduates, HNMUN brings over 2,000 students and
          faculty together from colleges and universities around the world to
