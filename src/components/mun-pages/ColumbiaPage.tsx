	...
	return (
		<div className="bg-[#111] text-white min-h-screen">
			...
			<div
				...
				style={{
					backgroundImage: "url('/columbia.jpg')",
				}}
			></div>
			...
			<div className="p-6">
				...
				<div className="bg-[#1a1a1a] p-4 rounded-lg leading-relaxed">
					Columbia Model United Nations (CMUN) is one of the leading
					academic simulations, bringing together students from around
					the globe to engage in diplomacy, policy debate, and global
					affairs in the spirit of the United Nations. Hosted at
					Columbia University, CMUN offers a diverse range of
					committees and fosters collaboration and leadership among
					participants.
				</div>
